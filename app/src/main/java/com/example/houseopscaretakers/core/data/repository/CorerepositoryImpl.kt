...
class CorerepositoryImpl(
    ...
    override suspend fun uploadImagesToStorage(
        ...
        val storageRef = FirebaseStorage.getInstance()
            .getReference("${houseModel.houseCategory}/${com.example.houseopscaretakers.core.Constants.HOUSE_IMAGES}")
                        ...
                        try {
                            fileRef.downloadUrl.addOnSuccessListener { url ->
                                ...
                                val apartmentCollection =
                                    db.collection(com.example.houseopscaretakers.core.Constants.APARTMENTS_COLLECTION)
    ...
    override suspend fun getCurrentHouse(
        ...
        db.collection(com.example.houseopscaretakers.core.Constants.APARTMENTS_COLLECTION).document(apartmentName)
            .collection(com.example.houseopscaretakers.core.Constants.HOUSES_SUB_COLLECTION).document(category)
            .addSnapshotListener { snapshot, error ->
