...
fun HyperLinkText(
    ...
    val annotatedString = buildAnnotatedString {
        ...
        linkText.forEachIndexed { index, link ->
            ...
            //  add annotation
            addStringAnnotation(
                tag = com.example.houseopscaretakers.feature_caretaker.core.Constants.ROUTE,
    ...
    ClickableText(
        ...
        onClick = {
            annotatedString
                .getStringAnnotations(com.example.houseopscaretakers.feature_caretaker.core.Constants.ROUTE, it, it)
